...
robust_data = np.load('controller_data_robust_scaled.npy', allow_pickle=True).item()
h2_data = np.load('controller_data_h2_scaled.npy', allow_pickle=True).item()
...
# Save results
np.save('worst_case_covariances_scaled.npy', covariances)
print("Worst-case covariances saved to 'worst_case_covariances_scaled.npy'")